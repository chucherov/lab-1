...
public class StudentJdbc {
    ...
    // Создание студента
    public void CreateStudent(int id, String surname, String name, String
            second_name) {
        this.jdbcTemplate.update(
                "INSERT INTO STUDENT VALUES(?, ?, ?, ?)", id, surname, name,second_name);
    }
    ...
    public void UpdateStudent(int id, String surname, String name, String
            second_name) {
        this.jdbcTemplate.update(
    ...
    public int UpdateStudent(Student student) {
        int status = jdbcTemplate.update("UPDATE STUDENT SET VALUES(?, ?, ?, ?)", student.getId(), student.getSurname(), student.getName(),student.getSecond_name());
        if(status == 0){
